...
void draw() {
  for (int i = 0; i < 320; i++) {
    stroke(i * 255 / 320, 200, 200 - i * 0.5);
    line(i, 0, i, 140);
  }
  noStroke();
  fill(255, 0, 110, 180);
...
void draw() {
  drawStar(80, 130, 40, 5, color(0, 208, 132));
  drawStar(160, 130, 50, 7, color(255, 0, 110));
  drawStar(240, 130, 40, 9, color(255, 200, 0));
}
...
void draw() {
  for (int y = 0; y < height; y++) {
    ...
    float r = lerp(10, 255, t);
    float g = lerp(14, 0, t);
    float b = lerp(39, 110, t);
    stroke(r, g, b);
    line(0, y, width, y);
  }
  noStroke();
