...
//   active → green dot with soft ring (current lesson, not yet marked done)
//   next   → hollow green circle (up next)
...
export default function StatusDot({ status, t, onToggle, title }: StatusDotProps) {
...
function renderInner(status: Status, t: Theme) {
  if (status === 'done') {
    return (
